...
window.SV_TOOLTIPS = {
  ...
  "house-morbray":     { kind: "House",  name: "Morbray",     text: "The Frontier Keepers. A grim, militaristic house holding the one reliable pass through the Eastern Massif with feared cavalry. Treat their border-lands like an armed camp." },
  ...
  "house-greyholt":    { kind: "House",  name: "Greyholt",    text: "The Hewers — the Major House of forestry. Branch-families run their own logging and lumber companies under the main family's great conglomerate; keeps forest-path mercenaries, for hire to anyone needing to cross the Great Forests." },
  "house-gallow":      { kind: "House",  name: "Gallow",      text: "The Quiet Branch — ancient, solitary house patrolling the southern road and the Great Plains. Hangs plains-bandits from the dead trees that scatter the expanse; so old no one knows whether the gallows is named for them, or they for it." },
  ...
  "aldric-greyholt": { kind: "NPC — House Greyholt", name: "Aldric Greyholt", text: "Lord of House Greyholt, master of Oakenhold. Broad and genial, more at home in a sawyard than at council. Guards the secret of the treated wood as closely as any Vane guards their steel." },
  "rowena-greyholt": { kind: "NPC — House Greyholt", name: "Rowena Greyholt", text: "Aldric's wife and co-head of the house. Older-blooded and statelier; carries Greyholt's weight at the High Council while he runs the camps. Keeps a Thorne's memory for debts and favours." },
  "osric-gallow":  { kind: "NPC — House Gallow",  name: "Osric Gallow",  text: "Lord of House Gallow, master of Aeruud. Grey, spare, economical with words, coin, and rope. Still rides the plains circuit himself; said to tie every noose his house uses with his own hands." },
  "aldith-gallow": { kind: "NPC — House Gallow",  name: "Aldith Gallow", text: "Osric's wife by a decades-old arrangement. Keeps Aeruud, the ledgers, and the cadet branches while he keeps the roads. No warmth, absolute loyalty — each would burn the kingdom for the other." },
  ...
  "amar-jannin":    { kind: "NPC — House Jannin",   name: "Lord Amar, 13th of that name", text: "Deceased patriarch. Took the borrowed name 'Amar' when he assumed Keep Amar, as twelve lords of that keep had done before him. Wise, wealthy, deeply respected. Killed at the siege; his wife is missing." },
  ...
  "fidarel":        { kind: "NPC — Deceased",       name: "Sovereign Fidarel", text: "Fidarel, First of his Ascendance — the Unclouded Sun. Deceased prior Lord of Lords: master of ruling his people, failure at ruling his household. A legion of bastards, no legitimate heir, no Dawn-Heir named. His death broke the kingdom." },
  ...
  "raven-garron":  { kind: "Stronghold", name: "Raven-Garron",  text: "House Morbray's fortress-town. Black-walled keep guarding the only reliably traversable pass through the Eastern Massif. Courtyard contains an ancient Dead Rowan Tree." },
  "holts-grove":   { kind: "City",       name: "Holt's Grove",  text: "House Greyholt's main city, on the path between the two edges of the Great Forests. Sawyards, seasoning sheds, and the counting-houses of Greyholt's family companies." },
  "weysend":       { kind: "Town",       name: "Weysend",       text: "House Gallow's walled town at the foot of Aeruud, where the southern road meets the Great Plains. 'Way's end' — the last town before the roads give out." },
  ...
  "valley-of-woe": { kind: "Geography",  name: "Valley of Woe", text: "River-valley cutting northeast through the Eastern Massif just beyond Raven-Garron — the only serious route beyond K'naan through the mountains. Morbray's keep guards its approach." },
  ...
  "corruption":        { kind: "System",    name: "Corruption",      text: "A spiritual blight that withers the soul and eventually twists the flesh. Gained from casting, blighted damage, learning magic, or pushing too far. Above Threshold, the gamble begins — fail your Resolute roll and you gain a Stigma." },
  "witchsight":        { kind: "Ability",   name: "Witchsight",      text: "A learned mystic sight that reads Shadows. It can attempt to pierce a Changeling's stolen face — a contested, corrupting effort, never automatic. Held by some trained Theurgs, senior Ordo wizards, some Inquisitors — and at least one dangerous figure in every High Council session." },
  ...
  "vigil":             { kind: "Ritual",    name: "Vigil of Absolute Disclosure", text: "Mandatory private rite for high officials and noble aspirants. Three days' fast, then a night in the crypt dictating every secret. If one is withheld, the Divining of the Lie follows. Noble marriages fall under it too: where a lineage is in doubt, the Vigil settles it." },
  ...
  "high-council":      { kind: "Institution", name: "High Council of Electors", text: "An assembly of the most powerful noble houses and a few important minor houses. In the Sovereign's absence, holds the kingdom in tense gridlock. It can elect a Sovereign — but cannot grant, seal, or revoke charters; only a Sovereign can." },
  ...
  "stigma":            { kind: "Mark",      name: "Stigma",           text: "A physical mark gained on a failed Threshold roll — under the house rules the Threshold is a gamble, not an instant scar. Weeping black tears, smell of rot, etc." },
  ...
  "lord-of-lords":     { kind: "Title",     name: "Lord of Lords",    text: "The historic title of the reigning Sovereign of K'naan, addressed as Your Radiance. Currently vacant — the Sun has set on the Fidarel Ascendance and the throne sits empty." },
  "sun-charter":       { kind: "Law",       name: "Sun-Charter",      text: "The great grant that makes a house major — a kingdom-scale monopoly, march, or office of the realm. Permanent once blood-sealed by a single marriage into the royal Ascendance; it survives the fall of dynasties." },
  "crown-charter":     { kind: "Law",       name: "Crown Charter",    text: "The instrument that makes a family a legal noble house — a minor house: name, arms, land at law, sworn levies. Granted by the Sovereign alone; reviewable by the next Sovereign once the granting royal line dies out." },
  "the-ascendance":    { kind: "Title",     name: "The Ascendance",   text: "The royal line — not a house. A crowned sovereign renounces their birth house, takes a regnal name, and is raised into the Sun. When a line fails: 'the Sun has set on the Ascendance.'" },
  "the-kindling":      { kind: "Rite",      name: "The Kindling",     text: "The rite of crowning: the chosen sovereign sheds their birth name and house and rises Ascendant under a regnal name." },
  "dawn-heir":         { kind: "Title",     name: "Dawn-Heir",        text: "The named royal successor within an Ascendance. Fidarel named none — hence the election." },
  ...
  "threshold":         { kind: "System",    name: "Threshold",        text: "Half your Resolute score (Resolute ÷ 2). 'Threshold' is just shorthand for that number. House rule — the Threshold is a gamble: when TotalCor goes above it you roll Resolute; fail, and you take a Stigma and 1d4 PermCor." },
