// ============================================================================
// SACRED VEIL — section content (verbatim from canonical doc)
// ============================================================================
// Every .body string is verbatim prose from the canonical doc.
...
// ───────────────────────── INTRODUCTION / HOOK ─────────────────────────
{
  ...
  blocks: [
    ...
    { type: "p", text: `In case you happen to be familiar with Symbaroum, FYI, this campaign homebrews the setting and system almost entirely to fit a world and long-term saga of its own. The campaigns do not take place within the world of Davokar. While we use the core engine of Symbaroum, please keep the following in mind:` },
    { type: "ul", items: [
...

{
  ...
  title: "The Hook",
  blocks: [
    { type: "p", text: `In the ancient world of Averium, in the kingdom of [[ash-kadesh:K'naan]], noble houses play a dangerous game of succession.` },
    ...
    { type: "p", text: `Despite being one of many potential candidates for the throne, Naviel has never been one for courtly politics. While he partook of the [[seraphs-marrow:Seraph's Marrow]], a dangerous chemical reserved for nobles and those with unendingly deep pockets that transforms the user in unpredictable and powerful ways, he remains a humble figure of slightly above average height; though he possesses rugged good looks, he lacks the overt physical transformations common to the anointed. Some whispers even suggest the chemical had no effect on him at all. He favours the dusty travel clothes and shepherd's crook of his station over the more regal vestments of his birthright, appearing more at home among his father's flock than in a palace. Practical, rugged, and genuinely kind, he is a man of the people rather than the crown.` },
    { type: "p", text: `The only real oddity about him — aside from an uncanny ability to charm everyone he meets despite his plain ways — is a strange pendant he's worn since he was a boy. It is a cluster of lavender flowers set with stones that seem to catch the light from within, given to him by a foreign girl he fell head-over-heels for in his youth. Sealed with a promise that they would surely meet again, he has never taken it off, and swears — though it has become a bit of a running joke now that he is a grown man — that he will still find her one day.` },
    { type: "p", text: `With the recent death of the [[lord-of-lords:Lord of Lords]], [[fidarel:Sovereign Fidarel]], the realm has fractured. Ambition has turned neighbours into vultures. But your house felt relatively safe — until tonight.` },
    { type: "p", text: `Your adventure will begin in the immediate aftermath of a sudden, overwhelming siege. It happened during a night patrol some time after Sovereign Fidarel's death. First came the thundering artillery that shattered your keep's ancient walls, then the overwhelming swarm of armored mercenaries. Through the ringing in your ears and the smoke choking the courtyard, you heard them shouting: <b>"FIND NAVIEL! FIND NAVIEL!"</b> You were helpless to stop what happened next. You watched Lord Amar fall to mercenary blades. You watched Naviel dragged unconscious across the bloody stone courtyard toward a transport. You even saw one of the attackers try to rip the lavender pendant from Naviel's neck, only to recoil with a confused yelp. As the transport makes haste you hear their commander snarl, <b>"Leave it! We'll cut it off him later!"</b>` },
    { type: "p", text: `When we roll our first dice, the keep is lost. The roof is collapsing, your employers are dead, and your ward is gone. [[amarsgate:Amarsgate]] below is burning. Your immediate goal is simple: fight your way out of the burning ruins alive. Your long-term goal? Track down the men who took Naviel, and figure out why.` },
  ],
},
