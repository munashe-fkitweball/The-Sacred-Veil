...
// ───────────────────────── INTRODUCTION / HOOK ─────────────────────────
{
  ...
  title: "Introduction",
  subtitle: "Welcome!",
  body: `If you are reading this, I must assume that you are here by invitation to a new campaign by myself, mc_samson - aka muna/caleb/etc. Perhaps we have already played some TTRPGs together, maybe I've even led them as your Game Master, but one thing we almost certainly haven't done together is…play Symbaroum!`,
  blocks: [
    ...
    { type: "p", text: `With that being said, I am planning to homebrew this setting and system almost entirely to fit a world and long term saga of my own creation. The campaigns will not take place within the world of Davokar. With that in mind, while we will be using the core engine of Symbaroum, please keep the following in mind as we begin:` },
    { type: "ul", items: [
      `<b>Early Changes:</b> Because this is my first time running this system, I may adjust certain mechanics over the first few sessions/first campaign to better suit the world. I'll keep these changes transparent and minimal.`,
      ...
      `<b>Refined Corruption:</b> One major immediate change I am planning to implement is changes to how [[corruption:Corruption]] works to make it a more interesting, long-term mechanical and narrative threat rather than just a quick "game over" stat.`,
      `<b>Lore & Names:</b> You will notice I am keeping most of the terminology and names the same where appropriate. However, do not rely on the sourcebooks as gospel truth. If you have a query about whether a piece of lore, a specific ability, or a world-rule is being retained, please just ask! I'd rather we be on the same page than have you build a character based on a book rule that doesn't exist in this version of the world.`,
    ]},
    { type: "p", text: `Below you'll find an outline of the world as a whole, but before that…` },
  ],
},
...

{
  ...
  blocks: [
    ...
    { type: "p", text: `When your TotalCor goes above half your Resolute score, you don't mutate instantly. Instead, you must immediately roll Resolute.` },
    { type: "ul", items: [
